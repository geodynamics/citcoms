...
#define MAX_LEVELS 6	/* max. multigrid levels */
/*#define MAX_S    30 */
#define NCS      50	/* max. sphere caps */
#define MAXP 20		/* max. plates */
...
#include "tracer_defs.h"
    ...
    float *stress[NCS];
    float *Fas670[NCS],*Fas410[NCS],*Fascmb[NCS],*Fas670_b[NCS],*Fas410_b[NCS],*Fascmb_b[NCS];
