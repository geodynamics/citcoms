...
void visc_from_T(struct All_variables *, float **);
void visc_from_S(struct All_variables *, float **);
void calc_radial_strain_rate_averages(struct All_variables *, float *);
