...
void return_elementwise_horiz_ave_float(struct All_variables *, int, float *, float *);
...
void viscy_from_element_to_nodes(struct All_variables *, float **, float **, int);
/* Output.c */
...
void gzdir_output_horiz_strain_rate_avg(struct All_variables *, int );
...
void init_strain(struct All_variables *); 
void init_tracer_strain(struct All_variables *);
void get_element_temperature(struct All_variables *, float *, int);
void get_element_yield(struct All_variables *, float *, int);
...
void adjust_visc_N0(struct All_variables *, float **);
