...
/* ================================================= */
 ...
 double cost,cosf,sint,sinf;
   ...
   for (i=1;i<=E->lmesh.NNO[level];i++)  {
     ...
     rtf[eqn1] = xyz[eqn1]*cost*cosf + xyz[eqn2]*cost*sinf - xyz[eqn3]*sint;
     rtf[eqn2] = -xyz[eqn1]*sinf + xyz[eqn2]*cosf;
     rtf[eqn3] = xyz[eqn1]*sint*cosf + xyz[eqn2]*sint*sinf + xyz[eqn3]*cost;
     }
 }
...
/* ================================================= */
 ...
 double cost,cosf,sint,sinf;
   ...
   for (i=1;i<=E->lmesh.NNO[level];i++)  {
     ...
     cost = E->SinCos[level][2][i];
     cosf = E->SinCos[level][3][i];
     xyz[eqn1] = rtf[eqn1]*cost*cosf - rtf[eqn2]*sinf + rtf[eqn3]*sint*cosf;
     xyz[eqn2] = rtf[eqn1]*cost*sinf + rtf[eqn2]*cosf + rtf[eqn3]*sint*sinf;
     xyz[eqn3] = -rtf[eqn1]*sint + rtf[eqn3]*cost;
     }
 }
